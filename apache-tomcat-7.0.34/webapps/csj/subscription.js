...
var tvPlanNamesList = ["Basic Internet/Cable TV $50/mo (50 channels & 20/5 Mbps)","Basic Plus Internet/Cable TV $75/mo (100 channels & 50/10 Mbps)","Ultimate Internet/Cable TV $100/mo (200 channels & 50/10 Mbps)"];
...
function getSubscriptionData (){
    ...
    var url = "./subscription?action=getSubscription";
    req = initRequest();
...
function handleCancelRequest(){
    ...
    if (responseXML == null) {
        $('#customerInfoContent').html("Sorry!Information not found.");
        return;
    } else {
...
function ppvCancelRequest(ppvID){
    var ajaxURL = "./subscription?action=cancelPPV&ppvID=" + ppvID;  
...
function sendOrderRequest(ppvID){
    var ajaxURL = "./subscription?action=orderPPV&ppvID=" + ppvID;  
    $.get( ajaxURL, function( data ) {
    });
}
...
function tvPlanRequest(id){
    var ajaxURL = "./subscription?action=tvPlan&tvID=" + id;  
    $.get( ajaxURL, function( data ) {
    });
}